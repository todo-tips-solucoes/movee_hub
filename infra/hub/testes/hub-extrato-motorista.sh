#!/usr/bin/env bash
# Driver do teste da 0089 (extrato do motorista) contra o hub-homolog.
#
...
#
#   infra/hub/testes/hub-adiantamento-categoria-familia.sh            # com a 0089
#   SEM_MIGRATION=1 infra/hub/testes/hub-adiantamento-categoria-familia.sh  # controle negativo
set -euo pipefail
RAIZ="$(cd "$(dirname "$0")/../../.." && pwd)"
DB=hub_homolog_db
MIG="$RAIZ/infra/hub/migrations/0089_extrato_motorista.sql"
TESTE="$RAIZ/infra/hub/testes/sql/0089-extrato-motorista.test.sql"
