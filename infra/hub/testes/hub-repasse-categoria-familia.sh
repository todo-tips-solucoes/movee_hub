#!/usr/bin/env bash
# Driver do teste da 0088 (família no repasse) contra o hub-homolog.
#
...
#
#   infra/hub/testes/hub-adiantamento-categoria-familia.sh            # com a 0088
#   SEM_MIGRATION=1 infra/hub/testes/hub-adiantamento-categoria-familia.sh  # controle negativo
set -euo pipefail
RAIZ="$(cd "$(dirname "$0")/../../.." && pwd)"
DB=hub_homolog_db
MIG="$RAIZ/infra/hub/migrations/0088_repasse_categoria_familia.sql"
TESTE="$RAIZ/infra/hub/testes/sql/0088-repasse-familia.test.sql"
